-- Optional finance category on split expenses (charts / Home categories).
...
-- List includes finance_category
...
-- Recreate create with optional p_finance_category (keeps premium checks + modes)
