...
const CATEGORY_KEYS: Record<string, TranslationKey> = {
  ...
  Fruits: 'cat.fruits',
  Flowers: 'cat.flowers',
  Withdraw: 'cat.withdraw',
  Loans: 'cat.loans',
  EMI: 'cat.emi',
  'Electricity Bill': 'cat.electricityBill',
  'Internet Bill': 'cat.internetBill',
  'Gas Bill': 'cat.gasBill',
  'Water Bill': 'cat.waterBill',
  'Gym Bill': 'cat.gymBill',
  Recharge: 'cat.recharge',
  'Bill Pay': 'cat.billPay',
  'Credit Card Bill': 'cat.creditCardBill',
  Others: 'cat.others',
  Salary: 'cat.salary',
