...
export function mergeGoogleAds(saved?: Partial<GoogleAdsConfig> | null): GoogleAdsConfig {
  ...
  return {
    ...
    androidBannerRemindersUnitId: unit('androidBannerRemindersUnitId'),
    iosBannerRemindersUnitId: unit('iosBannerRemindersUnitId'),
    androidBannerShoppingUnitId: unit('androidBannerShoppingUnitId'),
    iosBannerShoppingUnitId: unit('iosBannerShoppingUnitId'),
    androidBannerSplitUnitId: unit('androidBannerSplitUnitId'),
    iosBannerSplitUnitId: unit('iosBannerSplitUnitId'),
